...
public class F10_Son_Kullanici_Secimi : F10_Base
{
	...
	protected override void ItemSelected()
	{
		...
		{
			_selecteditems.Add(SonKullaniciData.GetSonKullanici(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, selecteditemsrecno));
		}

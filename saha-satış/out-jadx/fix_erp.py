...
# I want to replace the try block content for GOAPP ERP and FIELDOPS BRIDGE testing connection
start_marker = 'val formattedApiKey = if (apiKey.startsWith("AK-")) apiKey else "AK-$apiKey"'

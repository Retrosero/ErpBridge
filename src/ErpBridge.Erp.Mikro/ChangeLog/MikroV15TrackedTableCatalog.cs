...
/// <summary>
/// The Mikro <b>V15</b> tables ErpBridge mirrors through the shadow-table change log.
///
/// <para>
...
/// <c>TabloHelper.GetMikroV14DefaultTablolar()</c>, which has run against production Mikro
/// installations for years. Validated column-by-column against a live
/// <c>MikroDB_V15_02</c> database.
/// </para>
///
/// <para>V15 identifies rows by an <c>int</c> <c>*_RECno</c>; the change log stores it in <c>KayitRECno</c> and joins on it natively.</para>
///
/// <para>
...
/// </para>
/// </summary>
public sealed class MikroV15TrackedTableCatalog : IErpTrackedTableCatalog
{
    ...
    public static MikroV15TrackedTableCatalog Instance { get; } = new();
    ...
    private static ReadOnlyCollection<ErpTrackedTable> Build()
    {
        ...
        t.Add(new ErpTrackedTable(
            ...
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sto_RECno", "sto_kod", "sto_isim", "sto_kisa_ismi", "sto_yabanci_isim", "sto_sat_cari_kod",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "cari_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "cari_RECno", "cari_kod", "cari_unvan1", "cari_unvan2", "cari_muh_kod", "cari_muh_kod1",
                ...
                "cari_banka_hesapno1", "cari_CepTel", "cari_EMail", "cari_vade_fark_yuz",
                ...
                "cari_VarsayilanCikisDepo", "cari_RECid_DBCno", "cari_RECid_RECno"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 3,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "som_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "som_RECno", "som_kod", "som_isim"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 176,
            TableKey: "PROJELER",
            TableName: "PROJELER",
            SchemaName: "dbo",
            PrimaryKeyField: "pro_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "pro_RECno", "pro_kodu", "pro_adi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 11,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "san_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "san_RECno", "san_kod", "san_isim"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 12,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sta_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sta_RECno", "sta_kod", "sta_isim", "sta_ana_grup_kod"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 6,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "urt_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "urt_RECno", "urt_kod", "urt_ismi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 7,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ryn_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ryn_RECno", "ryn_kod", "ryn_ismi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 19,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "mrk_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "mrk_RECno", "mrk_kod", "mrk_ismi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 14,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "isk_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "isk_RECno", "isk_stok_kod", "isk_cari_kod", "isk_isim", "isk_isk1_aciklama",
        ...
        t.Add(new ErpTrackedTable(
            ...
            Fields: new[]
            {
                ...
                "sfiyat_odemeplan", "sfiyat_doviz", "sfiyat_deg_nedeni"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 227,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sfl_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sfl_RECno", "sfl_aciklama", "sfl_fiyatformul", "sfl_odeplformul", "sfl_sabit_iskonto",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "bar_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "bar_RECno", "bar_kodu", "bar_stokkodu", "bar_partikodu", "bar_serino_veya_bagkodu",
                "bar_lotno", "bar_barkodtipi", "bar_icerigi", "bar_birimpntr", "bar_master", "bar_bedenpntr",
                "bar_renkpntr", "bar_baglantitipi", "bar_harrecid_dbcno", "bar_harrecid_recno"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 32,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "adr_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "adr_RECno", "adr_cari_kod", "adr_cadde", "adr_sokak", "adr_posta_kodu", "adr_ilce", "adr_il",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "mye_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "mye_RECno", "mye_cari_kod", "mye_isim", "mye_soyisim", "mye_es_isim", "mye_dahili_telno",
        ...
        t.Add(new ErpTrackedTable(
            ...
            TableName: "DEPOLAR",
            SchemaName: "dbo",
            PrimaryKeyField: "dep_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "dep_RECno", "dep_adi", "dep_grup_kodu", "dep_muh_kodu", "dep_sor_mer_kodu", "dep_proje_kodu",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "odp_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "odp_RECno", "odp_kodu", "odp_adi", "odp_aratop", "odp_masraf", "odp_vergi", "odp_no",
                "odp_ortgun"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 53,
            ...
            TableName: "KASALAR",
            SchemaName: "dbo",
            PrimaryKeyField: "kas_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "kas_RECno", "kas_kod", "kas_isim", "kas_muh_kod", "kas_bankakodu", "kas_nakakincelenmesi",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "cha_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "cha_RECno", "cha_special1", "cha_special2", "cha_special3", "cha_aciklama", "cha_projekodu",
                ...
                "cha_vergi10", "cha_altd_kur", "cha_karsid_kur", "cha_RECid_RECno", "cha_tpoz",
                "cha_vergipntr", "cha_kasa_hizmet", "cha_firmano", "cha_subeno", "cha_tip", "cha_cinsi",
                "cha_normal_Iade", "cha_evrak_tip", "cha_satir_no", "cha_evrakno_sira", "cha_cari_cins",
                "cha_vade", "cha_grupno", "cha_d_cins", "cha_ticaret_turu", "cha_tarihi", "cha_belge_tarih",
                "cha_lastup_date"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 21,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sip_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sip_RECno", "sip_musteri_kod", "sip_special1", "sip_special2", "sip_special3",
                ...
                "sip_kapat_fl", "sip_tip", "sip_depono", "sip_RECid_DBCno", "sip_RECid_RECno", "sip_SpecRECno",
                "sip_fileid", "sip_checksum", "sip_create_user", "sip_lastup_user", "sip_firmano",
                "sip_subeno", "sip_cins", "sip_evrakno_sira", "sip_satirno", "sip_birim_pntr",
                "sip_vergi_pntr", "sip_masvergi_pntr", "sip_opno", "sip_OnaylayanKulNo", "sip_cari_grupno",
                "sip_doviz_cinsi", "sip_adresno", "sip_prosiprecDbId", "sip_prosiprecrecI", "sip_iskonto1",
                "sip_iskonto2", "sip_iskonto3", "sip_iskonto4", "sip_iskonto5", "sip_iskonto6", "sip_masraf1",
                "sip_masraf2", "sip_masraf3", "sip_masraf4", "sip_durumu", "sip_stalRecId_DBCno",
                "sip_stalRecId_RECno", "sip_teklifRecId_DBCno", "sip_teklifRecId_RECno", "sip_lot_no",
                "sip_fiyat_liste_no", "sip_Otv_Pntr", "sip_OtvVergisiz_Fl", "sip_RezRecId_DBCno",
                "sip_RezRecId_RECno", "sip_harekettipi", "sip_yetkili_recid_dbcno", "sip_yetkili_recid_recno",
                "sip_iptal", "sip_hidden", "sip_kilitli", "sip_degisti", "sip_vergisiz_fl", "sip_promosyon_fl",
        ...
        t.Add(new ErpTrackedTable(
            ...
            Fields: new[]
            {
                "pro_RECno", "pro_mustkodu", "pro_special1", "pro_special2", "pro_special3",
                "pro_evrakno_seri", "pro_belge_no", "pro_saticikodu", "pro_aciklama", "pro_aciklama2",
                "pro_cari_sormerk", "pro_stok_sormerk", "pro_teslimturu", "pro_Exp_Imp_Kodu", "pro_parti_kodu",
                "pro_projekodu", "pro_paket_kod", "pro_kapatmanedenkod", "pro_stokkodu", "pro_tutari",
                "pro_iskonto1", "pro_iskonto2", "pro_iskonto3", "pro_iskonto4", "pro_iskonto5", "pro_iskonto6",
                "pro_masraf1", "pro_masraf2", "pro_masraf3", "pro_masraf4", "pro_vergi", "pro_masrafvergi",
                "pro_dovizkuru", "pro_miktar", "pro_tesmiktari", "pro_bfiyati", "pro_altdovizkuru",
                "pro_karoani", "pro_planlananmiktar", "pro_Otv_Vergi", "pro_otvtutari", "pro_kapat",
                "pro_tipi", "pro_depono", "pro_RECid_DBCno", "pro_RECid_RECno", "pro_SpecRecNo", "pro_fileid",
                "pro_checksum", "pro_create_user", "pro_lastup_user", "pro_firmano", "pro_subeno", "pro_cinsi",
                "pro_evrakno_sira", "pro_satirno", "pro_birim_pntr", "pro_vergipntr", "pro_masrafvergipntr",
                "pro_opno", "pro_onaylayanKul_no", "pro_cari_grupno", "pro_dovizcinsi", "pro_adresno",
                "pro_isk_mas_1", "pro_isk_mas_2", "pro_isk_mas_3", "pro_isk_mas_4", "pro_isk_mas_5",
                "pro_isk_mas_6", "pro_isk_mas_7", "pro_isk_mas_8", "pro_isk_mas_9", "pro_isk_mas_10",
                "pro_durumu", "pro_stalRecId_DBCno", "pro_stalRecId_RECno", "pro_teklifRecId_DBCno",
                "pro_teklifRecId_RECno", "pro_lot_no", "pro_fiyat_liste_no", "pro_Otv_Pntr",
                "pro_OtvVergisiz_Fl", "pro_RezRecId_DBCno", "pro_RezRecId_RECno", "pro_harekettipi",
                "pro_yetkili_recid_dbcno", "pro_yetkili_recid_recno", "pro_iptal", "pro_hidden", "pro_kilitli",
                "pro_degisti", "pro_vergisiz", "pro_promosyon_fl", "pro_cagrilabilir_fl", "pro_sipDbID",
                "pro_sipRecID", "pro_sat_isk_mas1", "pro_sat_isk_mas2", "pro_sat_isk_mas3", "pro_sat_isk_mas4",
                "pro_sat_isk_mas5", "pro_sat_isk_mas6", "pro_sat_isk_mas7", "pro_sat_isk_mas8",
                "pro_sat_isk_mas9", "pro_sat_isk_mas10", "pro_create_date", "pro_tarihi", "pro_testarihi",
                "pro_belge_tarihi"
            }));
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "dov_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "dov_RECno", "dov_fiyat1", "dov_fiyat2", "dov_fiyat3", "dov_fiyat4", "dov_no", "dov_tarih"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 45,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sat_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sat_RECno", "sat_stok_kod", "sat_cari_kod", "sat_brut_fiyat", "sat_det_isk_yuzde1",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sas_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sas_RECno", "sas_stok_kod", "sas_cari_kod", "sas_brut_fiyat", "sas_isk_yuzde1",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sth_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sth_RECno", "sth_cari_kodu", "sth_stok_kod", "sth_evrakno_seri", "sth_plasiyer_kodu",
                "sth_cari_srm_merkezi", "sth_proje_kodu", "sth_aciklama", "sth_tutar", "sth_alt_doviz_kuru",
                "sth_vergi", "sth_har_doviz_kuru", "sth_iskonto1", "sth_iskonto2", "sth_iskonto3",
                "sth_iskonto4", "sth_iskonto5", "sth_iskonto6", "sth_masraf1", "sth_masraf2", "sth_masraf3",
                "sth_masraf4", "sth_masraf_vergi", "sth_miktar", "sth_miktar2", "sth_stok_doviz_kuru",
                "sth_cari_grup_no", "sth_firmano", "sth_subeno", "sth_normal_iade", "sth_birim_pntr",
                "sth_fiyat_liste_no", "sth_adres_no", "sth_tip", "sth_giris_depo_no", "sth_cikis_depo_no",
                "sth_evrakno_sira", "sth_cari_cinsi", "sth_evraktip", "sth_satirno", "sth_fat_recid_dbcno",
                "sth_fat_recid_recno", "sth_sip_recid_dbcno", "sth_sip_recid_recno", "sth_cins",
                "sth_vergi_pntr", "sth_har_doviz_cinsi", "sth_stok_doviz_cinsi", "sth_nakliyedeposu",
                "sth_nakliyedurumu", "sth_isk_mas1", "sth_isk_mas2", "sth_isk_mas3", "sth_isk_mas4",
                "sth_isk_mas5", "sth_isk_mas6", "sth_tarih", "sth_belge_tarih", "sth_lastup_date"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 54,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sck_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sck_RECno", "sck_sahip_cari_kodu", "sck_refno", "sck_bankano", "sck_srmmrk", "sck_borclu",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ct_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ct_RECno", "ct_carikodu", "ct_Aciklama_no", "ct_srmrkkodu", "ct_tutari", "ct_iptal",
        ...
        t.Add(new ErpTrackedTable(
            ...
            TableName: "FIRMALAR",
            SchemaName: "dbo",
            PrimaryKeyField: "fir_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "fir_RECno", "fir_unvan", "fir_sirano"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 112,
            TableKey: "SUBELER",
            TableName: "SUBELER",
            SchemaName: "dbo",
            PrimaryKeyField: "Sube_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "Sube_RECno", "Sube_adi", "Sube_no"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 52,
            TableKey: "BANKALAR",
            TableName: "BANKALAR",
            SchemaName: "dbo",
            PrimaryKeyField: "ban_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ban_RECno", "ban_ismi", "ban_sube", "ban_kod", "ban_firma_no", "ban_doviz_cinsi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 62,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "his_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "his_RECno", "his_kod", "his_isim", "his_yabanci_isim", "his_tipkod", "his_sinifkod",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "bankkod_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "bankkod_RECno", "bankkod_kod", "bankkod_subekodu", "bankkod_ilkodu", "bankkod_bankadi",
                "bankkod_subeadi"
            }));
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "zyrt_RecNo",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "zyrt_RecNo", "zyrt_Temsilci_Kodu", "zyrt_Cari_Kodu", "zyrt_Cari_Adres_No", "zyrt_Tarihi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 104,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "cari_per_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "cari_per_RECno", "cari_per_kod", "cari_per_adi", "cari_per_soyadi", "cari_per_kasiyerkodu",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "bol_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "bol_RECno", "bol_kod", "bol_ismi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 9,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "crg_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "crg_RECno", "crg_kod", "crg_isim", "crg_muhasebe_kodu"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 99,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "tslt_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "tslt_RECno", "tslt_kod", "tslt_ismi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 86,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ssip_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ssip_RECno", "ssip_special1", "ssip_special2", "ssip_special3", "ssip_evrakno_seri",
                "ssip_belgeno", "ssip_aciklama", "ssip_projekodu", "ssip_paket_kod", "ssip_kapatmanedenkod",
                "ssip_stok_kod", "ssip_tutar", "ssip_miktar", "ssip_teslim_miktar", "ssip_b_fiyat",
                "ssip_kapat_fl", "ssip_girdepo", "ssip_cikdepo", "ssip_RECid_DBCno", "ssip_RECid_RECno",
                "ssip_SpecRECno", "ssip_fileid", "ssip_checksum", "ssip_create_user", "ssip_lastup_user",
                "ssip_firmano", "ssip_subeno", "ssip_evrakno_sira", "ssip_satirno", "ssip_birim_pntr",
                "ssip_iptal", "ssip_hidden", "ssip_kilitli", "ssip_degisti", "ssip_stalRecId_DBCno",
                "ssip_stalRecId_RECno", "ssip_fiyat_liste_no", "ssip_create_date", "ssip_tarih",
                "ssip_teslim_tarih", "ssip_belge_tarih"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 66,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "egk_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "egk_RECno", "egk_special1", "egk_special2", "egk_special3", "egk_evr_seri", "egk_evracik1",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ktg_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ktg_RECno", "ktg_kod", "ktg_isim", "ktg_aciklama"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 8,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "sktr_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "sktr_RECno", "sktr_kod", "sktr_ismi", "sktr_muhkodu"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 122,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ihr_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ihr_RECno", "ihr_kodu", "ihr_ismi", "ihr_Satici", "ihr_RECid_DBCno", "ihr_RECid_RECno",
                "ihr_SpecRecNo", "ihr_firmano", "ihr_subeno", "ihr_TeslimSekli", "ihr_OdemeSekli",
                "ihr_carigrupno", "ihr_DovizCinsi", "ihr_create_date", "ihr_lastup_date", "ihr_GCB_Tarihi",
                "ihr_Intac_Tarihi"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 299,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "Kpm_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "Kpm_RECno", "Kpm_kod", "Kpm_ismi", "Kpm_aciklama"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 106,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "pak_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "pak_RECno", "pak_kod", "pak_stokkod", "pak_aciklama", "pak_ismi", "pak_miktar", "pak_fiyat",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "bdn_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "bdn_RECno", "bdn_kodu", "bdn_ismi", "bdn_kirilim_1", "bdn_kirilim_2", "bdn_kirilim_3",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "rnk_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "rnk_RECno", "rnk_kodu", "rnk_ismi", "rnk_kirilim_1", "rnk_kirilim_2", "rnk_kirilim_3",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "BdnHar_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "BdnHar_RECno", "BdnHar_HarGor", "BdnHar_KnsIsGor", "BdnHar_KnsFat", "BdnHar_TesMik",
                "BdnHar_rezervasyon_miktari", "BdnHar_rezerveden_teslim_edilen", "BdnHar_RECid_DBCno",
                "BdnHar_RECid_RECno", "BdnHar_Spec_Rec_no", "BdnHar_iptal", "BdnHar_fileid", "BdnHar_hidden",
                "BdnHar_kilitli", "BdnHar_degisti", "BdnHar_checksum", "BdnHar_create_user",
                "BdnHar_lastup_user", "BdnHar_Tipi", "BdnHar_DRECid_DBCno", "BdnHar_DRECid_RECno",
                "BdnHar_BedenNo", "BdnHar_special1", "BdnHar_special2", "BdnHar_special3",
                "BdnHar_create_date", "BdnHar_lastup_date"
            }));
        t.Add(new ErpTrackedTable(
            TableId: 94,
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "chz_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "chz_RECno", "chz_serino", "chz_stok_kodu", "chz_grup_kodu", "chz_Tuktckodu", "chz_aciklama1",
        ...
        t.Add(new ErpTrackedTable(
            ...
            SchemaName: "dbo",
            PrimaryKeyField: "ChHar_RECno",
            KeyKind: ErpRowKeyKind.Int,
            Fields: new[]
            {
                "ChHar_RECno", "ChHar_special1", "ChHar_special2", "ChHar_special3", "ChHar_SeriNo",
                "ChHar_StokKodu", "ChHar_RECid_DBCno", "ChHar_RECid_RECno", "ChHar_Spec_Rec_no",
                "ChHar_master_tablo", "ChHar_master_dbcno", "ChHar_master_recno", "ChHar_create_date",
                "ChHar_lastup_date"
            }));

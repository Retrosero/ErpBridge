...
public class SqlImport : XtraForm
{
	...
	private void cb_aktarimayarlari_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Parametreler parametreler = ParametrelerDefault.TahsilatAktarimSqlSablon(text);
		_ = DateTime.Now;
		...
		ParametreData.ParametreOku(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, parametreler, "TahsilatAktarim", "", "SqlAktarimSablon", text);
	}
	...
	private void InitializeComponent()
	{
		...
		base.Name = "SqlImport";
		this.Text = "Tahsilat evrak aktarımı (Sql)";

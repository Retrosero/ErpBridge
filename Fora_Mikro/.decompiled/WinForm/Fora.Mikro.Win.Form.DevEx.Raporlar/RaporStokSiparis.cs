...
public class RaporStokSiparis : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		bindingSource1.DataSource = typeof(RaporStokSiparisSonuc);
		...
		xrTable2.LocationFloat = new PointFloat(3.000005f, 0f);
		...
		xrTable1.LocationFloat = new PointFloat(3.000005f, 32.99996f);
		...
		xrLabel12.LocationFloat = new PointFloat(3.000005f, 10.00001f);
		...
		xrTable3.LocationFloat = new PointFloat(2.99991f, 0f);
		...
		base.Bands.AddRange(new Band[5] { Detail, TopMargin, BottomMargin, DetailReport, GroupFooter1 });

...
/// <summary>
/// bUnit tests for <see cref="ParameterMirror"/>, the read-only view of the raw Mikro
/// mirror. The page hits the central API at
...
/// </summary>
public sealed class ParameterMirrorTests : BunitContext
{
    [Fact]
    public void Renders_key_filter_and_load_button_initially()
    {
        ...
        var cut = Render<ParameterMirror>();

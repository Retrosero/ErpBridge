...
| 6 — Depo personeli sayfası | ✅ panel / ⬜ telefon | panel goal P4 | [GOAL_PANEL_GELISTIRMELERI.md](GOAL_PANEL_GELISTIRMELERI.md): `/depo` (sekmeler, tek dokunuşla adım, toplama listesi, geri al/iptal/yeniden ata, canlı long-poll), modül açılırken geri doldurma; telefon Depo ekranı P5 |

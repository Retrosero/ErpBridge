...
public class KriterDuzenleme : XtraForm
{
	...
	private TahsilatEvrakKriter genel_evrak_kriter;
	...
	private void lb_kullanicilar_SelectedValueChanged(object sender, EventArgs e)
	{
		...
		if (flag)
		{
			...
			genel_evrak_kriter = new TahsilatEvrakKriter();
			AktifKullanici = lb_kullanicilar.SelectedValue.ToString();
			_kullaniciparametreleri = ParametrelerDefault.TahsilatAktarimKriter(AktifKullanici);
			ParametreData.ParametreOku(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, _kullaniciparametreleri, "TahsilatAktarim", "", "Kriter", AktifKullanici);
			EkranBilgiGuncelle();
			DegisiklikVar = false;
		}
		else
	...
	private void kriterSilToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		if (flag)
		{
			...
			TahsilatEvrakKriterParametreleri.KriterSil(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, text);
			KullanicilariListele();
		}
	}
	...
	private void kriterEkleToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		Parametreler parametreler = ParametrelerDefault.TahsilatAktarimKriter(textSor.te_cevap.Text);
	...
	private void dosyayaYazToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		try
		{
			...
			if (saveFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				_kullaniciparametreleri.KullanimAlani = "TahsilatAktarimKriter";
	...
	private void dosyadanOkuToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		fileStream.Close();
		fileStream.Dispose();
		if (parametreler.KullanimAlani != "TahsilatAktarimKriter")
		{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Fora.App.Win.Mikro.TopluEvrakGirisi.TahsilatEvrakSatirBazli.Kriter.KriterDuzenleme));
		...
		base.SuspendLayout();
		this.lb_kullanicilar.Location = new System.Drawing.Point(13, 58);
		this.lb_kullanicilar.Name = "lb_kullanicilar";
		this.lb_kullanicilar.Size = new System.Drawing.Size(153, 502);
		...
		this.tc_parametreler.Size = new System.Drawing.Size(869, 530);
		...
		this.xtraTabPage_degistirilecek_alanlar.Size = new System.Drawing.Size(863, 502);
		...
		this.xtraTabPage3.Size = new System.Drawing.Size(863, 502);
		...
		this.xtraTabPage1.Size = new System.Drawing.Size(863, 502);
		...
		this.richTextBox1.Size = new System.Drawing.Size(863, 502);
		...
		this.labelControl2.Text = "Kriterler";

...
public class SonKullaniciSecimi : UserControl
{
	private SonKullanici _private_selecteditem;

	private string _private_CodeEmptyMessage = "Tüketici seçiniz";

	private string _private_NameEmptyMessage = "Tüketici seçiniz";
	...
	public SonKullanici SelectedItem
	{
		get
		{
		...
		set
		{
			...
			{
				be_kod.Text = _private_selecteditem.tuk_kodu;
				be_adi.Text = _private_selecteditem.tuk_ismi;
			}
			else
			{
	...
	[Description("TabStopCode")]
	[Category("Behavior")]
	public bool TabStopCode
	{
		get
		{
			return be_kod.TabStop;
		}
		set
		{
			be_kod.TabStop = value;
		}
	}

	[Description("TabStopName")]
	[Category("Behavior")]
	public bool TabStopName
	{
		get
		{
			return be_adi.TabStop;
		}
		set
		{
			be_adi.TabStop = value;
		}
	}
	...
	private void be_kod_ButtonClick(object sender, ButtonPressedEventArgs e)
	{
		...
		{
			F10_Son_Kullanici_Secimi_V16 f10_Son_Kullanici_Secimi_V = new F10_Son_Kullanici_Secimi_V16();
			f10_Son_Kullanici_Secimi_V.Setup(_mikrouygulamabilgileri, "SON_KULLANICILAR_CHOOSE_2", be_kod.Text, AllowMultiSelect: false, IlkAramaAktifOlsun: false);
			if (f10_Son_Kullanici_Secimi_V.ShowDialog() == DialogResult.OK)
			{
				SelectedItem = f10_Son_Kullanici_Secimi_V._selecteditems[0];
			}
		}
		else
		{
			F10_Son_Kullanici_Secimi f10_Son_Kullanici_Secimi = new F10_Son_Kullanici_Secimi();
			f10_Son_Kullanici_Secimi.Setup(_mikrouygulamabilgileri, "SON_KULLANICILAR_CHOOSE_2", be_kod.Text, AllowMultiSelect: false, IlkAramaAktifOlsun: false);
			if (f10_Son_Kullanici_Secimi.ShowDialog() == DialogResult.OK)
			{
				SelectedItem = f10_Son_Kullanici_Secimi._selecteditems[0];
			}
		}
	}
	...
	private void be_adi_Properties_ButtonClick(object sender, ButtonPressedEventArgs e)
	{
		...
		{
			F10_Son_Kullanici_Secimi_V16 f10_Son_Kullanici_Secimi_V = new F10_Son_Kullanici_Secimi_V16();
			f10_Son_Kullanici_Secimi_V.Setup(_mikrouygulamabilgileri, "SON_KULLANICILAR_CHOOSE_3", be_adi.Text, AllowMultiSelect: false, IlkAramaAktifOlsun: false);
			if (f10_Son_Kullanici_Secimi_V.ShowDialog() == DialogResult.OK)
			{
				SelectedItem = f10_Son_Kullanici_Secimi_V._selecteditems[0];
			}
		...
		{
			F10_Son_Kullanici_Secimi f10_Son_Kullanici_Secimi = new F10_Son_Kullanici_Secimi();
			f10_Son_Kullanici_Secimi.Setup(_mikrouygulamabilgileri, "SON_KULLANICILAR_CHOOSE_3", be_adi.Text, AllowMultiSelect: false, IlkAramaAktifOlsun: false);
			if (f10_Son_Kullanici_Secimi.ShowDialog() == DialogResult.OK)
			{
				SelectedItem = f10_Son_Kullanici_Secimi._selecteditems[0];
			}
	...
	private void be_kod_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			SonKullanici sonKullanici = SonKullaniciData.GetSonKullanici(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, be_kod.Text);
			if (sonKullanici.tuk_kodu == "")
			{
				e.Cancel = true;
			}
			else
			{
				SelectedItem = sonKullanici;
			}
		}
		else
		{
	...
	{
		if (be_adi.Text != "" && be_kod.Text != _private_NameEmptyMessage)
		{
			SonKullanici sonKullaniciByIsmi = SonKullaniciData.GetSonKullaniciByIsmi(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, be_adi.Text);
			if (sonKullaniciByIsmi.tuk_kodu == "")
			{
				e.Cancel = true;
			}
			else
			{
				SelectedItem = sonKullaniciByIsmi;
			}
		}
		else
		{
	...
	private void InitializeComponent()
	{
		...
		this.be_kod.Location = new System.Drawing.Point(87, 0);
		...
		this.be_adi.Location = new System.Drawing.Point(277, 0);
		...
		this.be_adi.Size = new System.Drawing.Size(150, 20);
		...
		this.label_code.Size = new System.Drawing.Size(78, 13);
		this.label_code.TabIndex = 10;
		this.label_code.Text = "Tüketici kodu :";
		this.label_name.AutoSize = true;
		this.label_name.Location = new System.Drawing.Point(203, 3);
		this.label_name.Name = "label_name";
		this.label_name.Size = new System.Drawing.Size(68, 13);
		this.label_name.TabIndex = 12;
		this.label_name.Text = "Tüketici adı :";
		...
		base.Name = "SonKullaniciSecimi";
		base.Size = new System.Drawing.Size(428, 20);

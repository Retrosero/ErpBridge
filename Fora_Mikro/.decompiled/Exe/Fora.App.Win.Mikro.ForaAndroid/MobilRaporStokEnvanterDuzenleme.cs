...
public class MobilRaporStokEnvanterDuzenleme : XtraForm
{
	...
	private RaporStokEnvanterSecenekleri AktifRapor;
	...
	private CheckEdit stokta_olan_urunler;
	...
	private System.Windows.Forms.ComboBox degerleme_sekli_secenegi;
	...
	private TextEdit fiyat_liste_no;

	private LabelControl labelControl8;

	public MobilRaporStokEnvanterDuzenleme(MikroUygulamaBilgileri mikrouygulamabilgileri)
	{
		...
		depolar_secenek.DataSource = dataSource;
		...
		stok_ana_gruplari_secenek.DataSource = dataSource2;
		...
		stok_uretici_kodu_secenek.DataSource = dataSource3;
		...
		stok_marka_kodu_secenek.DataSource = dataSource4;
		...
		stok_reyon_kodu_secenek.DataSource = dataSource5;
		...
		stok_kategori_kodu_secenek.DataSource = dataSource6;
		...
		DataTable dataSource7 = new DataTable
		{
			...
			{
				new object[2] { 0, "Stok" },
				new object[2] { 1, "Stok ana grubu" },
				new object[2] { 2, "Stok üretici" },
				new object[2] { 3, "Stok marka" },
				new object[2] { 4, "Stok reyon" },
				new object[2] { 5, "Stok kategori" },
				new object[2] { 6, "Depo" }
			}
		};
		gruplandirma_secenegi.DataSource = dataSource7;
		...
		stok_arama_secenekleri.DataSource = dataSource8;
		...
		siralama_secenegi.DataSource = dataSource9;
		...
		DataTable dataSource10 = new DataTable
		{
			...
			Rows = 
			{
				...
				new object[2] { 1, "Tutar" }
			}
		};
		tutar1_secenek.DataSource = dataSource10;
		...
		tutar2_secenek.DataSource = dataSource11;
		...
		tutar3_secenek.DataSource = dataSource12;
		...
		DataTable dataSource13 = new DataTable
		{
			...
			{
				new object[2] { 0, "Gösterme" },
				new object[2] { 1, "Miktar (1. birim)" },
				new object[2] { 2, "Miktar (2. birim)" },
				new object[2] { 3, "Miktar (3. birim)" }
			}
		};
		miktar1_secenek.DataSource = dataSource13;
		...
		miktar2_secenek.DataSource = dataSource14;
		...
		miktar3_secenek.DataSource = dataSource15;
		...
		DataTable dataSource16 = new DataTable
		{
			...
			Rows = 
			{
				new object[2] { 0, "Fiyat listesi" },
				new object[2] { 1, "Son satış fiyatı" },
				new object[2] { 2, "Son alış fiyatı" },
				new object[2] { 3, "Standart maliyet" }
			}
		};
		degerleme_sekli_secenegi.DataSource = dataSource16;
		degerleme_sekli_secenegi.ValueMember = "ID";
		degerleme_sekli_secenegi.DisplayMember = "Isim";
	...
	private void KullanicilariListele()
	{
		...
		string commandText = "SELECT ParametreUser FROM _FORA_PARAMETRELER WITH (NOLOCK) WHERE ParametreProgram='MobilRaporStokEnvanter' GROUP BY ParametreUser ORDER BY ParametreUser";
		try
		{
	...
	private void lb_kullanicilar_SelectedValueChanged(object sender, EventArgs e)
	{
		...
		if (flag)
		{
			...
			_raporparametreleri = ParametrelerDefault.MobilRaporStokEnvanter(AktifKullanici);
			ParametreData.ParametreOku(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, _raporparametreleri, "MobilRaporStokEnvanter", AktifKullanici, "", "");
			AktifRapor = JsonConvert.DeserializeObject<RaporStokEnvanterSecenekleri>(_raporparametreleri._GetParametre("RaporJson")._GetString);
			EkranBilgiGuncelle();
			DegisiklikVar = false;
		}
		else
	...
	private void EkranBilgiGuncelle()
	{
		...
		stokta_olan_urunler.Checked = AktifRapor.stokta_olan_urunler;
		...
		degerleme_sekli_secenegi.SelectedValue = (int)AktifRapor.degerleme_sekli;
		fiyat_liste_no.Text = AktifRapor.fiyat_liste_no;
	}
	...
	private void KullaniciParametreKaydet()
	{
		...
		AktifRapor.stokta_olan_urunler = stokta_olan_urunler.Checked;
		...
		AktifRapor.tutar1_secenek = (enum_stok_envanter_tutar_secenekleri)(int)tutar1_secenek.SelectedValue;
		AktifRapor.degistirebilir_tutar2_secenek = degistirebilir_tutar2_secenek.Checked;
		AktifRapor.tutar2_secenek = (enum_stok_envanter_tutar_secenekleri)(int)tutar2_secenek.SelectedValue;
		AktifRapor.degistirebilir_tutar3_secenek = degistirebilir_tutar3_secenek.Checked;
		AktifRapor.tutar3_secenek = (enum_stok_envanter_tutar_secenekleri)(int)tutar3_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar1_secenek = degistirebilir_miktar1_secenek.Checked;
		AktifRapor.miktar1_secenek = (enum_stok_envanter_miktar_secenekleri)(int)miktar1_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar2_secenek = degistirebilir_miktar2_secenek.Checked;
		AktifRapor.miktar2_secenek = (enum_stok_envanter_miktar_secenekleri)(int)miktar2_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar3_secenek = degistirebilir_miktar3_secenek.Checked;
		AktifRapor.miktar3_secenek = (enum_stok_envanter_miktar_secenekleri)(int)miktar3_secenek.SelectedValue;
		AktifRapor.degistirebilir_gruplandirma_secenegi = degistirebilir_gruplandirma_secenegi.Checked;
		AktifRapor.gruplandirma_secenegi = (enum_stok_envanter_gruplandirma_secenekleri)(int)gruplandirma_secenegi.SelectedValue;
		...
		AktifRapor.degerleme_sekli = (enum_stok_envanter_degerleme_sekli)(int)degerleme_sekli_secenegi.SelectedValue;
		AktifRapor.fiyat_liste_no = fiyat_liste_no.Text;
	...
	private void raporSilToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		string commandText = "DELETE _FORA_PARAMETRELER WHERE ParametreProgram='MobilRaporStokEnvanter' AND ParametreUser=@ParametreUser";
		try
		{
			SqlDB sqlDB = new SqlDB();
			sqlDB.ConnectionOpen(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName);
	...
	private void raporEkleToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		MobilRaporStokEnvanterEkle mobilRaporStokEnvanterEkle = new MobilRaporStokEnvanterEkle(_mikrouygulamabilgileri);
		mobilRaporStokEnvanterEkle.ShowDialog();
		if (mobilRaporStokEnvanterEkle.DialogResult == DialogResult.OK)
		{
			Parametreler parametreler = ParametrelerDefault.MobilRaporStokEnvanter(mobilRaporStokEnvanterEkle._RaporKodu);
			parametreler._GetParametre("RaporAdi")._SetString = mobilRaporStokEnvanterEkle._RaporAdi;
			parametreler._GetParametre("RaporJson")._SetString = JsonConvert.SerializeObject(new RaporStokEnvanterSecenekleri());
			...
			KullanicilariListele();
			lb_kullanicilar.SelectedItem = mobilRaporStokEnvanterEkle._RaporKodu;
		}
		mobilRaporStokEnvanterEkle.Dispose();
		mobilRaporStokEnvanterEkle = null;
	}
	...
	private void dosyayaYazToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		try
		{
			...
			if (saveFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				_raporparametreleri.KullanimAlani = "MobilRaporStokEnvanter";
	...
	private void dosyadanOkuToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		fileStream.Close();
		fileStream.Dispose();
		if (parametreler.KullanimAlani != "MobilRaporStokEnvanter")
		{
	...
	private void InitializeComponent()
	{
		...
		this.degerleme_sekli_secenegi = new System.Windows.Forms.ComboBox();
		...
		this.stokta_olan_urunler = new DevExpress.XtraEditors.CheckEdit();
		...
		this.fiyat_liste_no = new DevExpress.XtraEditors.TextEdit();
		...
		((System.ComponentModel.ISupportInitialize)this.stokta_olan_urunler.Properties).BeginInit();
		...
		((System.ComponentModel.ISupportInitialize)this.fiyat_liste_no.Properties).BeginInit();
		base.SuspendLayout();
		...
		this.xtraTabPage2.Controls.Add(this.fiyat_liste_no);
		this.xtraTabPage2.Controls.Add(this.labelControl8);
		this.xtraTabPage2.Controls.Add(this.labelControl7);
		this.xtraTabPage2.Controls.Add(this.degerleme_sekli_secenegi);
		...
		this.labelControl7.Location = new System.Drawing.Point(14, 394);
		this.labelControl7.Name = "labelControl7";
		this.labelControl7.Size = new System.Drawing.Size(122, 19);
		this.labelControl7.TabIndex = 235;
		this.labelControl7.Text = "Değerleme şekli :";
		this.degerleme_sekli_secenegi.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
		this.degerleme_sekli_secenegi.FormattingEnabled = true;
		this.degerleme_sekli_secenegi.Location = new System.Drawing.Point(142, 394);
		this.degerleme_sekli_secenegi.Name = "degerleme_sekli_secenegi";
		this.degerleme_sekli_secenegi.Size = new System.Drawing.Size(202, 21);
		this.degerleme_sekli_secenegi.TabIndex = 233;
		this.degerleme_sekli_secenegi.KeyDown += new System.Windows.Forms.KeyEventHandler(ParametreTextEdit_KeyDown);
		this.degerleme_sekli_secenegi.MouseClick += new System.Windows.Forms.MouseEventHandler(ParametreCheckEditMouseClick);
		...
		this.labelControl6.Location = new System.Drawing.Point(28, 340);
		...
		this.labelControl5.Location = new System.Drawing.Point(28, 313);
		...
		this.labelControl4.Location = new System.Drawing.Point(28, 286);
		...
		this.labelControl13.Location = new System.Drawing.Point(28, 238);
		...
		this.labelControl11.Location = new System.Drawing.Point(28, 211);
		...
		this.labelControl10.Location = new System.Drawing.Point(28, 184);
		...
		this.degistirebilir_miktar3_secenek.Location = new System.Drawing.Point(350, 340);
		...
		this.miktar3_secenek.Location = new System.Drawing.Point(142, 340);
		...
		this.degistirebilir_miktar2_secenek.Location = new System.Drawing.Point(350, 313);
		...
		this.miktar2_secenek.Location = new System.Drawing.Point(142, 313);
		...
		this.degistirebilir_miktar1_secenek.Location = new System.Drawing.Point(350, 286);
		...
		this.miktar1_secenek.Location = new System.Drawing.Point(142, 286);
		...
		this.degistirebilir_tutar3_secenek.Location = new System.Drawing.Point(350, 238);
		...
		this.tutar3_secenek.Location = new System.Drawing.Point(142, 238);
		...
		this.degistirebilir_tutar2_secenek.Location = new System.Drawing.Point(350, 211);
		...
		this.tutar2_secenek.Location = new System.Drawing.Point(142, 211);
		...
		this.degistirebilir_tutar1_secenek.Location = new System.Drawing.Point(350, 184);
		...
		this.tutar1_secenek.Location = new System.Drawing.Point(142, 184);
		...
		this.degistirebilir_siralama_secenegi.Location = new System.Drawing.Point(350, 137);
		...
		this.labelControl111.Appearance.Options.UseTextOptions = true;
		...
		this.labelControl111.Location = new System.Drawing.Point(28, 137);
		...
		this.siralama_secenegi.Location = new System.Drawing.Point(142, 137);
		...
		this.degistirebilir_gruplandirma_secenegi.Location = new System.Drawing.Point(350, 110);
		...
		this.labelControl90.Location = new System.Drawing.Point(28, 110);
		...
		this.gruplandirma_secenegi.Location = new System.Drawing.Point(142, 110);
		...
		this.xtraTabPage15.Controls.Add(this.stokta_olan_urunler);
		...
		this.stokta_olan_urunler.Location = new System.Drawing.Point(212, 249);
		this.stokta_olan_urunler.Name = "stokta_olan_urunler";
		this.stokta_olan_urunler.Properties.Caption = "";
		this.stokta_olan_urunler.Size = new System.Drawing.Size(135, 19);
		this.stokta_olan_urunler.TabIndex = 258;
		this.stokta_olan_urunler.KeyDown += new System.Windows.Forms.KeyEventHandler(ParametreTextEdit_KeyDown);
		this.stokta_olan_urunler.MouseClick += new System.Windows.Forms.MouseEventHandler(ParametreCheckEditMouseClick);
		...
		this.labelControl105.Location = new System.Drawing.Point(64, 249);
		...
		this.labelControl105.Text = "Stokta olan ürünler :";
		...
		this.labelControl96.Location = new System.Drawing.Point(489, 213);
		...
		this.depolar.Location = new System.Drawing.Point(351, 213);
		...
		this.depolar_secenek.Location = new System.Drawing.Point(212, 213);
		...
		this.labelControl93.Location = new System.Drawing.Point(64, 213);
		...
		this.raporEkleToolStripMenuItem.Size = new System.Drawing.Size(149, 22);
		...
		this.raporSilToolStripMenuItem.Size = new System.Drawing.Size(149, 22);
		...
		this.labelControl8.Location = new System.Drawing.Point(14, 432);
		this.labelControl8.Name = "labelControl8";
		this.labelControl8.Size = new System.Drawing.Size(122, 19);
		this.labelControl8.TabIndex = 236;
		this.labelControl8.Text = "Fiyat listesi no :";
		this.fiyat_liste_no.Location = new System.Drawing.Point(142, 433);
		this.fiyat_liste_no.Name = "fiyat_liste_no";
		this.fiyat_liste_no.Size = new System.Drawing.Size(202, 20);
		this.fiyat_liste_no.TabIndex = 237;
		...
		base.Name = "MobilRaporStokEnvanterDuzenleme";
		this.Text = "Stok Envanter Raporu Düzenleme";
		...
		((System.ComponentModel.ISupportInitialize)this.stokta_olan_urunler.Properties).EndInit();
		...
		((System.ComponentModel.ISupportInitialize)this.fiyat_liste_no.Properties).EndInit();

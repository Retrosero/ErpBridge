...
public class F10_Depo_Secimi : F10_Base
{
	...
	protected override void ItemSelected()
	{
		...
		{
			_selecteditems.Add(DepoData.GetDepoByRecNo(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, selecteditemsrecno));
		}

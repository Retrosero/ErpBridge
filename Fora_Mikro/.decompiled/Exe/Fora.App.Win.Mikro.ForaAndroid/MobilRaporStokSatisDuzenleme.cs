...
public class MobilRaporStokSatisDuzenleme : XtraForm
{
	...
	private RaporStokSatisSecenekleri AktifRapor;
	...
	private CheckEdit iadeler_dusulsun_mu;
	...
	private CheckEdit degistirebilir_fatura_durumu_secenegi;

	private System.Windows.Forms.ComboBox fatura_durumu_secenegi;
	...
	private ToolStripMenuItem raporSilToolStripMenuItem;

	private ToolStripMenuItem raporEkleToolStripMenuItem;
	...
	public MobilRaporStokSatisDuzenleme(MikroUygulamaBilgileri mikrouygulamabilgileri)
	{
		...
		DataTable dataSource17 = new DataTable
		{
			...
			Rows = 
			{
				...
				new object[2] { 1, "Brüt tutar" },
				new object[2] { 2, "İskonto tutarı" },
				new object[2] { 3, "Net tutar" },
				new object[2] { 4, "Net tutar (Kdv dahil)" },
				new object[2] { 5, "Net kar tutarı" },
				new object[2] { 6, "Net kar yüzdesi" },
				new object[2] { 7, "Net maliyet" }
			}
		};
		...
		DataTable dataSource20 = new DataTable
		{
			...
			{
				new object[2] { 0, "Gösterme" },
				new object[2] { 1, "Brüt satış miktarı" },
				new object[2] { 2, "İade miktarı" },
				new object[2] { 3, "Net satış miktarı" },
				new object[2] { 4, "Net satış miktarı (2. birim)" },
				new object[2] { 5, "Cari adre sayısı" },
				new object[2] { 6, "Net satış miktarı (3. birim)" }
			}
		};
		...
		DataTable dataSource23 = new DataTable
		{
			...
			Rows = 
			{
				...
				new object[2] { 1, "Faturalaşmışlar (Rapor tarihi içinde)" },
				new object[2] { 2, "İrsaliyeler" }
			}
		};
		fatura_durumu_secenegi.DataSource = dataSource23;
		fatura_durumu_secenegi.ValueMember = "ID";
		fatura_durumu_secenegi.DisplayMember = "Isim";
	...
	private void KullanicilariListele()
	{
		...
		string commandText = "SELECT ParametreUser FROM _FORA_PARAMETRELER WITH (NOLOCK) WHERE ParametreProgram='MobilRaporStokSatis' GROUP BY ParametreUser ORDER BY ParametreUser";
		try
		{
	...
	private void lb_kullanicilar_SelectedValueChanged(object sender, EventArgs e)
	{
		...
		if (flag)
		{
			...
			_raporparametreleri = ParametrelerDefault.MobilRaporStokSatis(AktifKullanici);
			ParametreData.ParametreOku(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, _raporparametreleri, "MobilRaporStokSatis", AktifKullanici, "", "");
			AktifRapor = JsonConvert.DeserializeObject<RaporStokSatisSecenekleri>(_raporparametreleri._GetParametre("RaporJson")._GetString);
			EkranBilgiGuncelle();
			DegisiklikVar = false;
		}
		else
	...
	private void EkranBilgiGuncelle()
	{
		...
		iadeler_dusulsun_mu.Checked = AktifRapor.iadeler_dusulsun_mu;
		...
		degistirebilir_fatura_durumu_secenegi.Checked = AktifRapor.degistirebilir_fatura_durumu_secenegi;
		fatura_durumu_secenegi.SelectedValue = (int)AktifRapor.fatura_durumu_secenegi;
	}
	...
	private void KullaniciParametreKaydet()
	{
		...
		AktifRapor.iadeler_dusulsun_mu = iadeler_dusulsun_mu.Checked;
		...
		AktifRapor.tutar1_secenek = (enum_tutar_secenekleri)(int)tutar1_secenek.SelectedValue;
		AktifRapor.degistirebilir_tutar2_secenek = degistirebilir_tutar2_secenek.Checked;
		AktifRapor.tutar2_secenek = (enum_tutar_secenekleri)(int)tutar2_secenek.SelectedValue;
		AktifRapor.degistirebilir_tutar3_secenek = degistirebilir_tutar3_secenek.Checked;
		AktifRapor.tutar3_secenek = (enum_tutar_secenekleri)(int)tutar3_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar1_secenek = degistirebilir_miktar1_secenek.Checked;
		AktifRapor.miktar1_secenek = (enum_miktar_secenekleri)(int)miktar1_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar2_secenek = degistirebilir_miktar2_secenek.Checked;
		AktifRapor.miktar2_secenek = (enum_miktar_secenekleri)(int)miktar2_secenek.SelectedValue;
		AktifRapor.degistirebilir_miktar3_secenek = degistirebilir_miktar3_secenek.Checked;
		AktifRapor.miktar3_secenek = (enum_miktar_secenekleri)(int)miktar3_secenek.SelectedValue;
		...
		AktifRapor.degistirebilir_fatura_durumu_secenegi = degistirebilir_fatura_durumu_secenegi.Checked;
		AktifRapor.fatura_durumu_secenegi = (enum_fatura_durumu_secenekleri)(int)fatura_durumu_secenegi.SelectedValue;
	...
	private void raporSilToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		string commandText = "DELETE _FORA_PARAMETRELER WHERE ParametreProgram='MobilRaporStokSatis' AND ParametreUser=@ParametreUser";
		try
		{
			SqlDB sqlDB = new SqlDB();
			sqlDB.ConnectionOpen(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName);
	...
	private void raporEkleToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		MobilRaporStokSatisEkle mobilRaporStokSatisEkle = new MobilRaporStokSatisEkle(_mikrouygulamabilgileri);
		mobilRaporStokSatisEkle.ShowDialog();
		if (mobilRaporStokSatisEkle.DialogResult == DialogResult.OK)
		{
			Parametreler parametreler = ParametrelerDefault.MobilRaporStokSatis(mobilRaporStokSatisEkle._RaporKodu);
			parametreler._GetParametre("RaporAdi")._SetString = mobilRaporStokSatisEkle._RaporAdi;
			parametreler._GetParametre("RaporJson")._SetString = JsonConvert.SerializeObject(new RaporStokSatisSecenekleri());
			...
			KullanicilariListele();
			lb_kullanicilar.SelectedItem = mobilRaporStokSatisEkle._RaporKodu;
		}
		mobilRaporStokSatisEkle.Dispose();
		mobilRaporStokSatisEkle = null;
	}
	...
	private void dosyayaYazToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		try
		{
			...
			if (saveFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				_raporparametreleri.KullanimAlani = "MobilRaporStokSatis";
	...
	private void dosyadanOkuToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		fileStream.Close();
		fileStream.Dispose();
		if (parametreler.KullanimAlani != "MobilRaporStokSatis")
		{
	...
	private void InitializeComponent()
	{
		...
		this.degistirebilir_fatura_durumu_secenegi = new DevExpress.XtraEditors.CheckEdit();
		this.fatura_durumu_secenegi = new System.Windows.Forms.ComboBox();
		...
		this.iadeler_dusulsun_mu = new DevExpress.XtraEditors.CheckEdit();
		...
		this.raporEkleToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
		...
		((System.ComponentModel.ISupportInitialize)this.degistirebilir_fatura_durumu_secenegi.Properties).BeginInit();
		...
		((System.ComponentModel.ISupportInitialize)this.iadeler_dusulsun_mu.Properties).BeginInit();
		...
		this.tc_parametrevehaklar.Location = new System.Drawing.Point(144, 30);
		this.tc_parametrevehaklar.Name = "tc_parametrevehaklar";
		this.tc_parametrevehaklar.SelectedTabPage = this.xtraTabPage2;
		this.tc_parametrevehaklar.Size = new System.Drawing.Size(787, 640);
		...
		this.xtraTabPage2.Controls.Add(this.degistirebilir_fatura_durumu_secenegi);
		this.xtraTabPage2.Controls.Add(this.fatura_durumu_secenegi);
		...
		this.xtraTabPage2.Size = new System.Drawing.Size(781, 612);
		...
		this.labelControl7.Location = new System.Drawing.Point(14, 443);
		this.labelControl7.Name = "labelControl7";
		this.labelControl7.Size = new System.Drawing.Size(122, 19);
		this.labelControl7.TabIndex = 235;
		this.labelControl7.Text = "Fatura durumu :";
		this.degistirebilir_fatura_durumu_secenegi.Location = new System.Drawing.Point(350, 443);
		this.degistirebilir_fatura_durumu_secenegi.Name = "degistirebilir_fatura_durumu_secenegi";
		this.degistirebilir_fatura_durumu_secenegi.Properties.Caption = "Değiştirebilir";
		this.degistirebilir_fatura_durumu_secenegi.Size = new System.Drawing.Size(84, 19);
		this.degistirebilir_fatura_durumu_secenegi.TabIndex = 234;
		this.degistirebilir_fatura_durumu_secenegi.KeyDown += new System.Windows.Forms.KeyEventHandler(ParametreTextEdit_KeyDown);
		this.degistirebilir_fatura_durumu_secenegi.MouseClick += new System.Windows.Forms.MouseEventHandler(ParametreCheckEditMouseClick);
		this.fatura_durumu_secenegi.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
		this.fatura_durumu_secenegi.FormattingEnabled = true;
		this.fatura_durumu_secenegi.Location = new System.Drawing.Point(142, 443);
		this.fatura_durumu_secenegi.Name = "fatura_durumu_secenegi";
		this.fatura_durumu_secenegi.Size = new System.Drawing.Size(202, 21);
		this.fatura_durumu_secenegi.TabIndex = 233;
		this.fatura_durumu_secenegi.KeyDown += new System.Windows.Forms.KeyEventHandler(ParametreTextEdit_KeyDown);
		this.fatura_durumu_secenegi.MouseClick += new System.Windows.Forms.MouseEventHandler(ParametreCheckEditMouseClick);
		...
		this.labelControl6.Location = new System.Drawing.Point(28, 389);
		this.labelControl6.Name = "labelControl6";
		this.labelControl6.Size = new System.Drawing.Size(108, 19);
		this.labelControl6.TabIndex = 232;
		this.labelControl6.Text = "Miktar 3 :";
		...
		this.labelControl13.Location = new System.Drawing.Point(28, 287);
		this.labelControl13.Name = "labelControl13";
		this.labelControl13.Size = new System.Drawing.Size(108, 19);
		this.labelControl13.TabIndex = 229;
		this.labelControl13.Text = "Tutar 3 :";
		...
		this.labelControl11.Location = new System.Drawing.Point(28, 260);
		this.labelControl11.Name = "labelControl11";
		this.labelControl11.Size = new System.Drawing.Size(108, 19);
		this.labelControl11.TabIndex = 228;
		this.labelControl11.Text = "Tutar 2 :";
		...
		this.labelControl10.Location = new System.Drawing.Point(28, 233);
		this.labelControl10.Name = "labelControl10";
		this.labelControl10.Size = new System.Drawing.Size(108, 19);
		this.labelControl10.TabIndex = 227;
		this.labelControl10.Text = "Tutar 1 :";
		this.degistirebilir_miktar3_secenek.Location = new System.Drawing.Point(350, 389);
		...
		this.miktar3_secenek.Location = new System.Drawing.Point(142, 389);
		this.miktar3_secenek.Name = "miktar3_secenek";
		this.miktar3_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.degistirebilir_miktar2_secenek.Location = new System.Drawing.Point(350, 362);
		...
		this.miktar2_secenek.Location = new System.Drawing.Point(142, 362);
		this.miktar2_secenek.Name = "miktar2_secenek";
		this.miktar2_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.degistirebilir_miktar1_secenek.Location = new System.Drawing.Point(350, 335);
		...
		this.miktar1_secenek.Location = new System.Drawing.Point(142, 335);
		this.miktar1_secenek.Name = "miktar1_secenek";
		this.miktar1_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.degistirebilir_tutar3_secenek.Location = new System.Drawing.Point(350, 287);
		...
		this.tutar3_secenek.Location = new System.Drawing.Point(142, 287);
		this.tutar3_secenek.Name = "tutar3_secenek";
		this.tutar3_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.degistirebilir_tutar2_secenek.Location = new System.Drawing.Point(350, 260);
		...
		this.tutar2_secenek.Location = new System.Drawing.Point(142, 260);
		this.tutar2_secenek.Name = "tutar2_secenek";
		this.tutar2_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.degistirebilir_tutar1_secenek.Location = new System.Drawing.Point(350, 233);
		...
		this.tutar1_secenek.Location = new System.Drawing.Point(142, 233);
		this.tutar1_secenek.Name = "tutar1_secenek";
		this.tutar1_secenek.Size = new System.Drawing.Size(202, 21);
		...
		this.RaporAdi.Location = new System.Drawing.Point(142, 64);
		...
		this.te_kullanici_adi.Location = new System.Drawing.Point(142, 38);
		...
		this.degistirebilir_siralama_secenegi.Location = new System.Drawing.Point(350, 186);
		...
		this.labelControl111.Location = new System.Drawing.Point(28, 186);
		this.labelControl111.Name = "labelControl111";
		this.labelControl111.Size = new System.Drawing.Size(108, 19);
		...
		this.siralama_secenegi.Location = new System.Drawing.Point(142, 186);
		...
		this.degistirebilir_gruplandirma_secenegi.Location = new System.Drawing.Point(350, 159);
		...
		this.labelControl90.Location = new System.Drawing.Point(28, 159);
		this.labelControl90.Name = "labelControl90";
		this.labelControl90.Size = new System.Drawing.Size(108, 19);
		...
		this.gruplandirma_secenegi.Location = new System.Drawing.Point(142, 159);
		...
		this.degistirebilir_tarih_cinsi.Location = new System.Drawing.Point(350, 132);
		...
		this.labelControl57.Location = new System.Drawing.Point(28, 132);
		this.labelControl57.Name = "labelControl57";
		this.labelControl57.Size = new System.Drawing.Size(108, 19);
		...
		this.tarih_cinsi.Location = new System.Drawing.Point(142, 132);
		this.tarih_cinsi.Name = "tarih_cinsi";
		this.tarih_cinsi.Size = new System.Drawing.Size(202, 21);
		...
		this.xtraTabPage15.Controls.Add(this.iadeler_dusulsun_mu);
		this.xtraTabPage15.Controls.Add(this.labelControl105);
		...
		this.xtraTabPage15.Size = new System.Drawing.Size(781, 612);
		this.xtraTabPage15.Text = "Filitreler";
		this.iadeler_dusulsun_mu.Location = new System.Drawing.Point(212, 455);
		this.iadeler_dusulsun_mu.Name = "iadeler_dusulsun_mu";
		this.iadeler_dusulsun_mu.Properties.Caption = "";
		this.iadeler_dusulsun_mu.Size = new System.Drawing.Size(135, 19);
		this.iadeler_dusulsun_mu.TabIndex = 258;
		this.iadeler_dusulsun_mu.KeyDown += new System.Windows.Forms.KeyEventHandler(ParametreTextEdit_KeyDown);
		this.iadeler_dusulsun_mu.MouseClick += new System.Windows.Forms.MouseEventHandler(ParametreCheckEditMouseClick);
		...
		this.labelControl105.Location = new System.Drawing.Point(64, 455);
		this.labelControl105.Name = "labelControl105";
		this.labelControl105.Size = new System.Drawing.Size(142, 19);
		this.labelControl105.TabIndex = 256;
		this.labelControl105.Text = "İadeler düşülsün :";
		...
		this.labelControl96.Location = new System.Drawing.Point(489, 417);
		...
		this.depolar.Location = new System.Drawing.Point(351, 417);
		...
		this.depolar_secenek.Location = new System.Drawing.Point(212, 417);
		...
		this.labelControl93.Location = new System.Drawing.Point(64, 417);
		this.labelControl93.Name = "labelControl93";
		this.labelControl93.Size = new System.Drawing.Size(142, 19);
		...
		this.labelControl107.Location = new System.Drawing.Point(491, 393);
		...
		this.sorumluluk_merkezleri.Location = new System.Drawing.Point(351, 390);
		...
		this.sorumluluk_merkezleri_secenek.Location = new System.Drawing.Point(212, 390);
		...
		this.labelControl110.Location = new System.Drawing.Point(64, 390);
		...
		this.labelControl97.Location = new System.Drawing.Point(490, 366);
		...
		this.proje_kodlari.Location = new System.Drawing.Point(352, 363);
		...
		this.proje_kodlari_secenek.Location = new System.Drawing.Point(213, 363);
		...
		this.labelControl106.Location = new System.Drawing.Point(64, 363);
		...
		this.labelControl47.Location = new System.Drawing.Point(490, 316);
		...
		this.cari_grup_kodlari.Location = new System.Drawing.Point(351, 312);
		...
		this.cari_grup_kodu_secenek.Location = new System.Drawing.Point(213, 313);
		...
		this.labelControl50.Location = new System.Drawing.Point(64, 313);
		...
		this.labelControl34.Location = new System.Drawing.Point(490, 289);
		...
		this.cari_bolge_kodlari.Location = new System.Drawing.Point(352, 286);
		...
		this.cari_bolge_kodu_secenek.Location = new System.Drawing.Point(213, 286);
		...
		this.labelControl43.Location = new System.Drawing.Point(64, 286);
		...
		this.labelControl51.Location = new System.Drawing.Point(489, 262);
		...
		this.cari_temsilci_kodlari.Location = new System.Drawing.Point(352, 259);
		...
		this.cari_temsilci_kodu_secenek.Location = new System.Drawing.Point(212, 259);
		...
		this.labelControl54.Location = new System.Drawing.Point(64, 259);
		...
		this.cari_arama_metin.Location = new System.Drawing.Point(352, 232);
		...
		this.cari_arama_secenekleri.Location = new System.Drawing.Point(212, 232);
		...
		this.labelControl46.Location = new System.Drawing.Point(64, 232);
		...
		this.labelControl30.Location = new System.Drawing.Point(490, 189);
		...
		this.stok_kategori_kodlari.Location = new System.Drawing.Point(352, 186);
		...
		this.stok_kategori_kodu_secenek.Location = new System.Drawing.Point(212, 186);
		...
		this.labelControl33.Location = new System.Drawing.Point(64, 186);
		this.labelControl33.Name = "labelControl33";
		this.labelControl33.Size = new System.Drawing.Size(142, 19);
		...
		this.labelControl26.Location = new System.Drawing.Point(490, 162);
		...
		this.stok_reyon_kodlari.Location = new System.Drawing.Point(352, 159);
		...
		this.stok_reyon_kodu_secenek.Location = new System.Drawing.Point(212, 159);
		...
		this.labelControl29.Location = new System.Drawing.Point(64, 159);
		this.labelControl29.Name = "labelControl29";
		this.labelControl29.Size = new System.Drawing.Size(142, 19);
		...
		this.labelControl22.Location = new System.Drawing.Point(489, 135);
		...
		this.stok_marka_kodlari.Location = new System.Drawing.Point(351, 132);
		...
		this.stok_marka_kodu_secenek.Location = new System.Drawing.Point(212, 132);
		...
		this.labelControl25.Location = new System.Drawing.Point(64, 132);
		this.labelControl25.Name = "labelControl25";
		this.labelControl25.Size = new System.Drawing.Size(142, 19);
		...
		this.labelControl16.Location = new System.Drawing.Point(490, 108);
		...
		this.stok_uretici_kodlari.Location = new System.Drawing.Point(352, 103);
		...
		this.stok_uretici_kodu_secenek.Location = new System.Drawing.Point(213, 105);
		...
		this.labelControl20.Location = new System.Drawing.Point(64, 103);
		this.labelControl20.Name = "labelControl20";
		this.labelControl20.Size = new System.Drawing.Size(142, 19);
		...
		this.labelControl9.Location = new System.Drawing.Point(490, 81);
		...
		this.stok_ana_gruplari.Location = new System.Drawing.Point(352, 78);
		...
		this.stok_ana_gruplari_secenek.Location = new System.Drawing.Point(213, 78);
		...
		this.labelControl15.Location = new System.Drawing.Point(64, 78);
		this.labelControl15.Name = "labelControl15";
		this.labelControl15.Size = new System.Drawing.Size(142, 19);
		this.labelControl15.TabIndex = 169;
		this.labelControl15.Text = "Stok ana grupları :";
		this.stok_arama_metin.Location = new System.Drawing.Point(351, 51);
		...
		this.stok_arama_secenekleri.Location = new System.Drawing.Point(212, 51);
		...
		this.labelControl12.Location = new System.Drawing.Point(64, 52);
		...
		this.lb_kullanicilar.Location = new System.Drawing.Point(12, 53);
		this.lb_kullanicilar.Name = "lb_kullanicilar";
		this.lb_kullanicilar.Size = new System.Drawing.Size(127, 612);
		...
		this.dosyaToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[6] { this.degisiklikleriKaydetToolStripMenuItem, this.raporEkleToolStripMenuItem, this.raporSilToolStripMenuItem, this.toolStripSeparator1, this.dosyayaYazToolStripMenuItem, this.dosyadanOkuToolStripMenuItem });
		...
		this.raporSilToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
		this.raporSilToolStripMenuItem.Text = "Sil";
		this.raporSilToolStripMenuItem.Click += new System.EventHandler(raporSilToolStripMenuItem_Click);
		this.raporEkleToolStripMenuItem.Name = "raporEkleToolStripMenuItem";
		this.raporEkleToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
		this.raporEkleToolStripMenuItem.Text = "Ekle";
		this.raporEkleToolStripMenuItem.Click += new System.EventHandler(raporEkleToolStripMenuItem_Click);
		this.toolStripSeparator1.Name = "toolStripSeparator1";
		this.toolStripSeparator1.Size = new System.Drawing.Size(175, 6);
		this.dosyayaYazToolStripMenuItem.Name = "dosyayaYazToolStripMenuItem";
		this.dosyayaYazToolStripMenuItem.Size = new System.Drawing.Size(178, 22);
		...
		this.dosyadanOkuToolStripMenuItem.Size = new System.Drawing.Size(178, 22);
		...
		this.label718.Location = new System.Drawing.Point(12, 36);
		this.label718.Name = "label718";
		this.label718.Size = new System.Drawing.Size(59, 14);
		this.label718.TabIndex = 105;
		...
		base.Name = "MobilRaporStokSatisDuzenleme";
		this.Text = "Stok Satış Raporu Düzenleme";
		...
		((System.ComponentModel.ISupportInitialize)this.degistirebilir_fatura_durumu_secenegi.Properties).EndInit();
		...
		((System.ComponentModel.ISupportInitialize)this.iadeler_dusulsun_mu.Properties).EndInit();

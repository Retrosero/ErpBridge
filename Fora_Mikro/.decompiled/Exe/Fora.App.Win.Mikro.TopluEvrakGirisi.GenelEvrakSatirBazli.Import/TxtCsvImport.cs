...
public class TxtCsvImport : XtraForm
{
	...
	{
		openFileDialog1.Filter = "TXT Dosyaları|*.txt|CSV Dosyaları|*.csv|XML Dosyaları|*.xml|Tüm dosyalar|*.*";
	...
	private void cb_aktarimayarlari_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		Parametreler parametreler = ParametrelerDefault.GenelAktarimTxtCsvSablon(text);
		ParametreData.ParametreOku(_mikrouygulamabilgileri.baglantibilgileri, _mikrouygulamabilgileri.MikroFirmaDBName, parametreler, "GenelAktarim", "", "TxtCsvAktarimSablon", text);
	...
	private void InitializeComponent()
	{
		...
		this.sb_aktarima_basla.Location = new System.Drawing.Point(330, 98);
		...
		this.te_dosyaadi.Location = new System.Drawing.Point(142, 57);
		this.te_dosyaadi.Name = "te_dosyaadi";
		this.te_dosyaadi.Size = new System.Drawing.Size(237, 20);
		this.te_dosyaadi.TabIndex = 21;
		...
		this.Text = "Genel evrak aktarımı (Txt/Csv/Xml)";

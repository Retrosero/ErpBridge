...
public class RaporStokEnvanter : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		xrLabel12.Text = "Stok envanter raporu";
		...
		bindingSource1.DataSource = typeof(RaporStokEnvanterSonuc);

...
E4 — hesap hareketleri (ekstre) ve düzeltme: `ledger_void`/`ledger_adjustment` belge türleri, düzenleme ucu, ekstre sözleşmesine `voided`/`editable` alanları, panel `/cari` ekstresinde Düzenle·İptal et·Geçmiş.

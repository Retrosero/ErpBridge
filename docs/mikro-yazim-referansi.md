...
`tests/ErpBridge.Erp.Mikro.Tests/Integration/MikroNativeDocumentConventionTests.cs` (salt okuma,
`ERPBridge_RUN_INTEGRATION=1`, veritabanı `ERPBridge_MIKRO_WRITE_DB` varsayılan `MikroDB_V15_ERPBTEST`):

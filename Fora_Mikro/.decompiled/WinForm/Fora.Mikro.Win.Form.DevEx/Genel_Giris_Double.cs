...
public class Genel_Giris_Double : XtraForm
{
	private string _tag;
	...
	public double _GetDoubleValue
	{
		get
		{
			double result = 0.0;
			double.TryParse(te_deger.Text.Replace(".", ","), out result);
			return result;
		}
	}

	public Genel_Giris_Double(string tag, string baslik, string onaybutonismi, string defaultdeger)
	{
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		this.te_deger.Properties.Mask.EditMask = "f4";
		this.te_deger.Properties.Mask.MaskType = DevExpress.XtraEditors.Mask.MaskType.Numeric;

...
| # | Görev | Çıktı |
|---|---|---|
| **P0a** | `ParametrelerDefault.cs` → `catalog/parameters/defaults.json`. 13 programın 4.688 tanımı: `program`, `scopeKind`, `parametreId`, `ad`, `varsayilan` | 4.688 kayıt, sayım testi |
